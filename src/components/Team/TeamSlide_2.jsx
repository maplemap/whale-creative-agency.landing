    ...
    <div className="team__body">
      <article className="description description--team" data-num="2">
        ...
        <p className="description__text">
          ...
          Our goal is to drive your business growth by keeping design affordable
           yet still beautiful and exclusive.
          We offer a full stack of design services: brand identity,
           logo design, mobile app and website design,
